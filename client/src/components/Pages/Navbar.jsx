...
const Navbar = () => {
  ...
  return (
    <nav
      className="navbar bg-transparent  border-b rounded border-b-indigo-500 w-full z-20 top-0 left-0"
      ...
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div className="flex md:order-2">
          <Link to="/login">
            <button
              type="button"
              className="text-white  bg-blue-700focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm px-10 py-2 text-center mr-3 md:mr-0 dark:bg-blue-900 dark:hover:bg-green-700  dark:focus:ring-blue-800"
            >
              Login
            </button>
          </Link>
